  ...
  return (
    ...
    >
      <Heading className="text-gray-900 text-[20px] font-bold text-center p-0 my-[30px] mx-0">
        Declaração processada com sucesso e sem pendências
      </Heading>
      ...
      <Section className="my-[24px]">
        {lines.length > 0 ? (
          ...
          <Text className="text-gray-800 text-[14px] leading-[24px]">
            Sua Declaração de Imposto de Renda {anoBase || ''} foi <strong>processada com sucesso e sem pendências pela Receita Federal</strong>.
...
export const template = {
  ...
  previewData: {
    ...
    anoBase: '2026',
    mensagemPersonalizada:
      'Sua Declaração de Imposto de Renda 2026 foi **processada com sucesso e sem pendências pela Receita Federal**.\nEm anexo o documento que comprova o processamento.',
    attachmentLinks: [
