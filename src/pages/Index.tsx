...
export default function Index() {
  return (
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      {/* ══════════════════════════════════════════════════════
          4. APRESENTAÇÃO DO PRODUTO — with mockup
         ══════════════════════════════════════════════════════ */}
              ...
              <div className="flex-1 relative w-full max-w-lg lg:max-w-none">
                ...
                <div className="absolute top-6 right-4 glass-card-strong rounded-xl mockup-shadow animate-float p-3 z-10">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <p className="font-display font-bold text-foreground text-base">-85%</p>
                      <p className="text-xs text-muted-foreground">tempo de coleta</p>
                    </div>
                  </div>
                </div>
                <div className="absolute bottom-12 left-4 glass-card-strong rounded-xl mockup-shadow animate-float-delayed p-3 z-10">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <p className="font-display font-bold text-foreground text-base">3x mais</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {featuresTranslated.map((f) => (
              <GlassCard
                key={f.title}
                className="p-8 group hover:shadow-xl hover:scale-[1.02] transition-all duration-300"
              >
      ...
      {/* ══════════════════════════════════════════════════════
          FEATURE SHOWCASES — Visual deep dives with mockups
         ══════════════════════════════════════════════════════ */}
      <Section className="relative overflow-hidden">
        <div className="absolute inset-0 bg-primary" />
              ...
              <div className="flex-1 relative w-full max-w-lg lg:max-w-none">
                ...
                <div className="absolute top-5 right-4 glass-card-strong rounded-xl mockup-shadow animate-float p-3 z-10">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <p className="font-display font-bold text-foreground text-base">189</p>
                      <p className="text-xs text-muted-foreground">declarações ativas</p>
                    </div>
                  </div>
                </div>
                <div className="absolute bottom-10 left-4 glass-card-strong rounded-xl mockup-shadow animate-float-delayed p-3 z-10">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <p className="font-display font-bold text-foreground text-base">+34%</p>
                      <p className="text-xs text-muted-foreground">produtividade</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="flex-1 relative w-full max-w-lg lg:max-w-none">
                ...
                <div className="absolute top-5 left-4 glass-card-strong rounded-xl mockup-shadow animate-float p-3 z-10">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <p className="font-display font-bold text-foreground text-base">12/14</p>
                      <p className="text-xs text-muted-foreground">docs recebidos</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      {/* ══════════════════════════════════════════════════════
          8. QUEBRA DE OBJEÇÃO — with lion background
         ══════════════════════════════════════════════════════ */}
      <Section className="relative overflow-hidden">
        <div className="absolute inset-0">
