...
const PLANOS_CONFIG = [
  ...
  },
  {
    ...
    cta: 'Fazer upgrade',
    beneficios: [
      { texto: '3 declarações inclusas no plano', disponivel: true, destaque: true, addon: false, preco: 0 },
      { texto: 'R$ 4,90/declaração avulsa', disponivel: true, destaque: true, addon: false, preco: 0 },
